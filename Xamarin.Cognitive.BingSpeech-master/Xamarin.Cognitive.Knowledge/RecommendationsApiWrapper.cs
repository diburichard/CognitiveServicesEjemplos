namespace Recommendations
{
    ...
    public class RecommendationsApiWrapper
    {
        ...
        {
            BaseUri = baseUri;
            /* System.Net.WebProxy p = new System.Net.WebProxy( "proxytmg",8080);
             p.Credentials = new System.Net.NetworkCredential("eromero", "NuncaJama$$08", "central");         
             HttpClientHandler handler = new HttpClientHandler
             {
                 Proxy = p
             };
             _httpClient = new HttpClient(handler) { BaseAddress = new Uri(BaseUri),
